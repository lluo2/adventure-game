...
public class GameMap {
	...
	private String gameMapFile = "C:/workspace/adventure-time/src/gameMap.tgf";
	private String keyTextFile = "C:/workspace/adventure-time/src/keyText.txt";
	private String doorTextFile = "C:/workspace/adventure-time/src/doorText.txt";
  
	public GameMap() {
		map = new AdjMatGraph<String>();
		try {
			AdjMatGraph.loadTGF(gameMapFile, map);   //Check if valid tgf file
		} catch (FileNotFoundException ex) {
			System.out.println("error: tgf file not found");
			ex.printStackTrace();
		}
		...
		buildKeyDict(keyTextFile);
		buildDoorDict(doorTextFile);
		buildRooms();
	...
	/** 
	 * Builds the Door Dictionary out of a text file that contains a message when the door
	 * is locked and a message it returns when it is successfully unlocked by a key.
	 * 
	 ...
	 * FUTURE EXPANSION: Using a traversal to find a far enough room to be the future room. 
	 ...
	 * @param: -- 
	 * @return: LinkedList<Room> connectingRooms 
	 */
	public LinkedList<Room> getConnectingRooms() { return rooms.get(currentRoom); }
  
	/** Returns true if user player reaches the final room.
	 * @param: -- 
	 * @return: boolean foundFinalRoom
	 */
	public boolean endOfMap() { return currentRoom.equals(finalRoom); }
  
	/**
	 * GETTER: Returns a randomly selected key from the key Dictionary.
	 * Used to fill the spots of the remaining
	 ...
	 * @param: -- 
	 * @return: Hashtable<Integer, Key> allKeys 
	 */
	public static Hashtable<Integer, Key> getAllKeys() { return allKeys; }  
	...
	/** 
	 * Replaces the door pointer to that of door zero to simulate the door being unlocked.
	 ...
	 * @return: boolean chancesExist 
	 * @param: -- 
	 */
	public boolean chancesLeft() { return chancesLeft > 0; }
  
	/**
	 * Returns the number of chances left to guess wrong.
	 * @param: -- 
	 * @return: int numberOfChances 
	 */
	public int getChances() { return chancesLeft; }
	 ...
	 * @return: -- 
	 */
	public void wrongAnswer() { chancesLeft--; }
  
	/** 
	 * Prints a string representation of the possible rooms the player can enter. 
	 * Only used for the Driver class.
	 */
	...
	/** 
	 * Prints a string representation of the possible keys a player can enter. 
	 * Only used for the Driver Class. 
	 */
